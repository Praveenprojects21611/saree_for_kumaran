...
@app.route('/category/design_blouse_36')
def design_blouse_36():
    logger.info("Entering design_blouse_36 route")
    return render_template('design_blouse_36.html')

@app.route('/category/design_blouse_44')
def design_blouse_44():
